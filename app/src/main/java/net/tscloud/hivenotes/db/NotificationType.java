...
public class NotificationType {
    ...
    static {
        ...
        keyToDesc.put(NOTIFY_PEST_REMOVE_DRONE, NOTIFY_REMOVE_DRONE_DESC);
        keyToDesc.put(NOTIFY_PEST_REMOVE_MITES, NOTIFY_REMOVE_MITES_DESC);
        ...
        keyToDesc.put(NOTIFY_OTHER_PLIT_HIVE, NOTIFY_OTHER_SPLIT_HIVE_DESC);
    }
